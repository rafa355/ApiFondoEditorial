...
<!-- Notification 1  -->
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"  bgcolor="#f2f4f9" style="" 
style="background-color: rgb(242, 244, 249);"
>
          ...
          <td width="100%" height="100" align="center">
            ...
            <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="-webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px;">
              <tbody>
                <tr>
                <td width="100%" 
                style="-webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px; -webkit-box-shadow: 0px 0px 6px 0px rgba(0,0,0,0.75); -moz-box-shadow: 0px 0px 6px 0px rgba(0,0,0,0.75); box-shadow: 0px 0px 6px 0px rgba(0,0,0,0.10);"                bgcolor="#ffffff">
            
                  <!-- SORTABLE -->
                  <div class="sortable_inner ui-sortable">
                  <!-- Start Top -->
                  <table width="500" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#0a3677" 
                    ...
                    <tbody><tr>
                      <td width="100%" valign="middle" align="center">
                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          ...
                          <tr>
                            <td width="100%"  >
                            <!-- <img src="{{ asset('images/logofe.png') }}"  border="0" class="hover" mc:edit="1_6" style="height:60px"> !-->
                            <img src="https://fondo-editorial.herokuapp.com/assets/images/logofe.png"  border="0" class="hover" mc:edit="1_6" style="height:60px">
                            </td>
                          </tr>
                          <tr>
